...
# Makes CustomTkinter scale correctly
ctk.set_widget_scaling(1.2)   # try 1.2, 1.3, or 1.5
...
root.geometry("1600x900") # May need to change this line to fit different computer screens
...
for col in columns:
    ...
    treeview.column(col, width=500)  # Adjust column width for readability
